            ...
            <el-col>
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" v-for="str in ad">
                            <img :src="str.url"/>
                        </div>
                    </div>
                    <div class="swiper-button-prev"><i class="el-icon-arrow-left"></i></div><!--左箭头-->
                    <div class="swiper-button-next"><i class="el-icon-arrow-right"></i></div><!--右箭头-->
        ...
        mounted() {
            ...
            this.axios.get('/api/advert').then((response) => {
                ...
                response.data.forEach(function (e) {
                    ad.push({url:e.image,'building':e.id});
                    //console.log(e);
                });
                this.ad = ad;
            }).catch((error)=>{
