<template>
	<el-col :span="24">
		...
		<section class="product_content">
			...
			<div style="clear: both;"></div>
				<el-pagination  @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage" prev-text="上一页"  next-text="下一页" background
			:page-sizes="[5, 8, 10, 12]" :page-size="pagesize" background layout="prev, pager, next" :total="prolist.length">
					</el-pagination>
		</section>
...
<script>
	...
	export default {
		...
		methods: {
			buildprolist() {
				this.axios.get('/api/buildprolist').then(res => {

					this.prolist = res.data.data //请求出来的标签数据			
