	...
	<el-col :span="24">
		...
		<ul class="Com-nav" v-for="(item,index) in coutryCom" :key='index'>
			...
			<el-popover placement="bottom" trigger="hover" popper-class="popoverouzhou">
					...
					<a class="itma" v-popover:popoverouzhou slot='reference'>欧洲版块 <i class="el-icon-arrow-down iconsss"></i></a>
				</el-popover>
			</li>
			<li class="itm">
				<router-link to='' class="itma">亚洲版块</router-link>
			</li>
			<li class="itm">
				<router-link to='' class="itma">美洲版块</router-link>
			</li>
			<li class="itm">
				<router-link to='' class="itma">大洋洲版块</router-link>
			</li>
			<li class="itm">
				<router-link to='' class="itma">非洲版块</router-link>
			</li>
			<li class="itm">
